	...
	<div class="panel panel-default" id="vb_head">
		  <!-- Default panel contents -->
			<div name="head">
					<div class="btn-group" id="vb_head_controls">
						<button type="button" class="btn btn-default">Add Users</button>
		  ...
		  <table class="table">
			  ...
			  <tr>
				  ...
				  <td class="col-sm-5">Jane Doe</td>     
				  <td class="col-sm-4">Approver</td>     
			  ...
			  <div class="row">
				...
				<td class="col-sm-1" align="center">					
				  ...
				  <td class="col-sm-5">Juan Dela Cruz</td>     
				  <td class="col-sm-4">Administrator</td>     
				  <td class="col-sm-2"><a href="#">Edit</a></td>     				
				</tr>
			  </div>							  
			  <div class="row">
				<tr>
				  ...
				  <td class="col-sm-5">Juana Dela Cruz</td>     
				  <td class="col-sm-4">Administrator</td>     
				  <td class="col-sm-2"><a href="#">Edit</a></td>     
				</tr>
			  </div>		  
