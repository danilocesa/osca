   ...
   $.fn.formError =
      function( message, options)
      {
         ...
         function show( options)
         {
            ...
            var errorDiv =
               $("<div class='validationErrorContainer' style='position:absolute; left:-10px; top:30px; z-index:99999'>" +
                      "<div class='validationError' style='font-size:0.8em; border:2px solid #811; border-radius:5px; padding:4px; background-color:#f99; color:#511; position:relative; left:10px; white-space:nowrap;'>" +
                     options.message +
                   "</div>" +
                 "</div>");
            ...
            {
               this.wrap( $("<div class='inputContainer' style='display:inline;position:relative; width:" + this.width() + "px'></div>"));
            }
